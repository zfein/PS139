...
with open('data.csv', 'wb') as out_f:
    ...
    start = 'http://www.slelections.gov.lk/presidential2015/province.html'
    ...
    for row in links.findAll('tr')[3:12]: # Look through rows of the main table
        ...
        link = 'http://www.slelections.gov.lk/presidential2015/' + link
        ...
        for drow in districtlinks.findAll('tr')[2:]: # Look through districts
            ...
            dlink = 'http://www.slelections.gov.lk/presidential2015/' + dlink
            ...
            for divrow in divlinks.findAll('tr')[2:]: # Look through divisions
                ...
                divlink = 'http://www.slelections.gov.lk/presidential2015/' + \
                    divlink
